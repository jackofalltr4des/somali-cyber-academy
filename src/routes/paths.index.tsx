  ...
  return (
    <>
      ...
      <h1 className="mt-4 font-display text-3xl font-bold sm:text-4xl">
        Waddooyinka xirfadda
      </h1>

      <p className="mt-3 max-w-2xl text-muted-foreground">
        Waddo kastaa waxay leedahay heer adkaan, liis koorsooyin ah, nidaam
        barasho la talis ah iyo natiijo shaqo. Waddada{" "}
        <strong className="text-foreground">SOC Analyst</strong> ayaa hadda
        diyaar ah oo buuxda.
      </p>
